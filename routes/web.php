...
use App\Http\Controllers\Client\ClubServiceNoteController;
...
Route::middleware(['auth', 'access.web', 'tenant.plan', 'check.tenant.subscription'])
    ...
    ->group(function () {
        ...
        Route::get('clubes/{club}/servicios/crear', [ClubServiceNoteController::class, 'create'])->name('clubes.services.create');
        Route::post('clubes/{club}/servicios', [ClubServiceNoteController::class, 'store'])->name('clubes.services.store');
        Route::get('clubes/{club}/servicios/{clubNote}/editar', [ClubServiceNoteController::class, 'edit'])->name('clubes.services.edit');
        Route::put('clubes/{club}/servicios/{clubNote}', [ClubServiceNoteController::class, 'update'])->name('clubes.services.update');
        Route::get('clubes/{club}/servicios/{clubNote}/ticket', [ClubServiceNoteController::class, 'ticket'])->name('clubes.services.ticket');
        Route::get('clubes/{club}/servicios/{clubNote}/pdf', [ClubServiceNoteController::class, 'pdf'])->name('clubes.services.pdf');
        Route::delete('clubes/{club}/servicios/{clubNote}', [ClubServiceNoteController::class, 'destroy'])->name('clubes.services.destroy');
