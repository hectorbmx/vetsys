...
<div class="p-6 max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-xl font-black theme-text-heading uppercase tracking-widest">Facturación</h1>
        ...
        <a href="{{ route('client.facturacion.notas') }}"
           class="theme-button-dark px-5 py-3 rounded-xl font-bold text-xs tracking-wide shadow-sm transition-all flex items-center gap-2">
            + Facturar Nota
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white border border-slate-200 rounded-[22px] p-5 shadow-sm">
            ...
            <h2 class="text-2xl font-black theme-text-heading mt-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <a href="{{ route('client.facturacion.notas') }}"
           class="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm hover:border-slate-300 hover:shadow-md transition-all block">
            ...
            <h3 class="text-sm font-black theme-text-heading uppercase tracking-widest">Notas por Facturar</h3>
        ...
        <a href="#"
           class="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm hover:border-slate-300 hover:shadow-md transition-all block">
            <div class="text-2xl mb-3">📄</div>
            <h3 class="text-sm font-black theme-text-heading uppercase tracking-widest">Facturas Emitidas</h3>
            <p class="text-xs text-slate-400 mt-2">
        ...
        <a href="#"
           class="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm hover:border-slate-300 hover:shadow-md transition-all block">
            ...
            <h3 class="text-sm font-black theme-text-heading uppercase tracking-widest">Configuración Fiscal</h3>
            <p class="text-xs text-slate-400 mt-2">
    ...
    <div class="bg-white border border-slate-200 rounded-[24px] shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50">
            <h2 class="text-sm font-black theme-text-heading uppercase tracking-widest">Flujo de Facturación</h2>
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="border border-slate-100 rounded-2xl p-4">
                ...
                <h3 class="text-sm font-bold theme-text-heading mt-2">Crear Nota</h3>
            ...
            <div class="border border-slate-100 rounded-2xl p-4">
                ...
                <h3 class="text-sm font-bold theme-text-heading mt-2">Cobrar Nota</h3>
            ...
            <div class="border border-slate-100 rounded-2xl p-4">
                ...
                <h3 class="text-sm font-bold theme-text-heading mt-2">Seleccionar Nota</h3>
            ...
            <div class="border border-slate-100 rounded-2xl p-4">
                ...
                <h3 class="text-sm font-bold theme-text-heading mt-2">Emitir CFDI</h3>
